...
public class WisePuhi {
    ...
    public String chat(String query) throws Exception {
        ...
        } else if (query.contains("photo") && query.endsWith("me") ){
            try{
                capImage();
            }catch(Exception ex) {
                response = "can't capture your image, sorry!";
    ...
    void capImage()
    {
        CanvasFrame canvas = new CanvasFrame("MeenaCam");
        ...
        try {
            ...
            Logger.getLogger(WisePuhi.class.getName()).log(Level.SEVERE, null, ex);
        }
